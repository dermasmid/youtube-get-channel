...
class Common:
    ...
    def format_geckodriver_list(cls, operating_system):
        return [
            cls.format_driver_information(
                operating_system, 'v0.29.1', '≥ 87', 'geckodriver', 'Mozilla Firefox'),
            cls.format_geckodriver_download_command(
                operating_system, 'v0.29.1'),
            cls.format_driver_information(
                operating_system, 'v0.29.0', '≥ 84', 'geckodriver', 'Mozilla Firefox'),
            cls.format_geckodriver_download_command(
                operating_system, 'v0.29.0'),
            cls.format_driver_information(
                operating_system, 'v0.28.0', '≥ 82', 'geckodriver', 'Mozilla Firefox'),
            cls.format_geckodriver_download_command(
                operating_system, 'v0.28.0'),
            cls.format_driver_information(
                operating_system, 'v0.27.0', '≥ 78', 'geckodriver', 'Mozilla Firefox'),
            cls.format_geckodriver_download_command(
                operating_system, 'v0.27.0'),
            cls.format_driver_information(
                operating_system, 'v0.26.0', '≥ 60', 'geckodriver', 'Mozilla Firefox'),
            cls.format_geckodriver_download_command(
                operating_system, 'v0.26.0')
        ]
    ...
    def format_operadriver_list(cls, operating_system):
        return [
            cls.format_driver_information(
                operating_system, 'v.90.0.4430.85',  'Stable 76', 'operadriver', 'Opera'),
            cls.format_operadriver_download_command(
                operating_system, 'v.90.0.4430.85'),
            cls.format_driver_information(
                operating_system, 'v.89.0.4389.82',  'Stable 75', 'operadriver', 'Opera'),
            cls.format_operadriver_download_command(
                operating_system, 'v.89.0.4389.82'),
            cls.format_driver_information(
                operating_system, 'v.88.0.4324.104', 'Stable 74', 'operadriver', 'Opera'),
            cls.format_operadriver_download_command(
                operating_system, 'v.88.0.4324.104'),
            cls.format_driver_information(
                operating_system, 'v.87.0.4280.67',  'Stable 73', 'operadriver', 'Opera'),
            cls.format_operadriver_download_command(
                operating_system, 'v.87.0.4280.67'),
            cls.format_driver_information(
                operating_system, 'v.86.0.4240.80',  'Stable 72', 'operadriver', 'Opera'),
            cls.format_operadriver_download_command(
                operating_system, 'v.86.0.4240.80'),
            cls.format_driver_information(
                operating_system, 'v.85.0.4183.102', 'Stable 71', 'operadriver', 'Opera'),
            cls.format_operadriver_download_command(
                operating_system, 'v.85.0.4183.102'),
            cls.format_driver_information(
                operating_system, 'v.84.0.4147.89',  'Stable 70', 'operadriver', 'Opera'),
            cls.format_operadriver_download_command(
                operating_system, 'v.84.0.4147.89'),
            cls.format_driver_information(
                operating_system, 'v.83.0.4103.97',  'Stable 69', 'operadriver', 'Opera'),
            cls.format_operadriver_download_command(
                operating_system, 'v.83.0.4103.97'),
            # there was no operdriver v.82.#.####.##
            cls.format_driver_information(
                operating_system, 'v.81.0.4044.113', 'Stable 68', 'operadriver', 'Opera'),
            cls.format_operadriver_download_command(
                operating_system, 'v.81.0.4044.113'),
            cls.format_driver_information(
                operating_system, 'v.80.0.3987.100', 'Stable 67', 'operadriver', 'Opera'),
            cls.format_operadriver_download_command(
                operating_system, 'v.80.0.3987.100'),
            cls.format_driver_information(
                operating_system, 'v.79.0.3945.79',  'Stable 66', 'operadriver', 'Opera'),
            cls.format_operadriver_download_command(
                operating_system, 'v.79.0.3945.79'),
            cls.format_driver_information(
                operating_system, 'v.78.0.3904.87',  'Stable 65', 'operadriver', 'Opera'),
            cls.format_operadriver_download_command(
                operating_system, 'v.78.0.3904.87'),
            cls.format_driver_information(
                operating_system, 'v.77.0.3865.120', '64',        'operadriver', 'Opera'),
            cls.format_operadriver_download_command(
                operating_system, 'v.77.0.3865.120'),
            cls.format_driver_information(
                operating_system, 'v.76.0.3809.132', '63',        'operadriver', 'Opera'),
            cls.format_operadriver_download_command(
                operating_system, 'v.76.0.3809.132'),
            cls.format_driver_information(
                operating_system, 'v.75.0.3770.100', '62',        'operadriver', 'Opera'),
            cls.format_operadriver_download_command(
                operating_system, 'v.75.0.3770.100'),
            cls.format_driver_information(
                operating_system, 'v.2.45',          '60',        'operadriver', 'Opera'),
            cls.format_operadriver_download_command(
                operating_system, 'v.2.45'),
            cls.format_driver_information(
                operating_system, 'v.2.42',          '58',        'operadriver', 'Opera'),
            cls.format_operadriver_download_command(
                operating_system, 'v.2.42'),
            cls.format_driver_information(
                operating_system, 'v.2.41',          '57',        'operadriver', 'Opera'),
            cls.format_operadriver_download_command(
                operating_system, 'v.2.41'),
            cls.format_driver_information(
                operating_system, 'v.2.40',          '56',        'operadriver', 'Opera'),
            cls.format_operadriver_download_command(
                operating_system, 'v.2.40'),
            cls.format_driver_information(
                operating_system, 'v.2.38',          '55',        'operadriver', 'Opera'),
            cls.format_operadriver_download_command(
                operating_system, 'v.2.38'),
            cls.format_driver_information(
                operating_system, 'v.2.37',          '54',        'operadriver', 'Opera'),
            cls.format_operadriver_download_command(
                operating_system, 'v.2.37'),
            cls.format_driver_information(
                operating_system, 'v.2.36',          '53',        'operadriver', 'Opera'),
            cls.format_operadriver_download_command(
                operating_system, 'v.2.36'),
            cls.format_driver_information(
                operating_system, 'v.2.35',          '52',        'operadriver', 'Opera'),
            cls.format_operadriver_download_command(
                operating_system, 'v.2.35'),
            # there was no operdriver release specifically for Opera 51
            # there was no operadriver v.2.34
            cls.format_driver_information(
                operating_system, 'v.2.33',          '50',        'operadriver', 'Opera'),
            cls.format_operadriver_download_command(
                operating_system, 'v.2.33'),
            cls.format_driver_information(
                operating_system, 'v.2.32',          '49',        'operadriver', 'Opera'),
            cls.format_operadriver_download_command(
                operating_system, 'v.2.32'),
            # there was no operadriver v.2.31
            cls.format_driver_information(
                operating_system, 'v.2.30',          '48',        'operadriver', 'Opera'),
            cls.format_operadriver_download_command(
                operating_system, 'v.2.30'),
            # there was no operdriver release specifically for Opera 47
            cls.format_driver_information(
                operating_system, 'v.2.29',          '46',        'operadriver', 'Opera'),
            cls.format_operadriver_download_command(
                operating_system, 'v.2.29'),
        ]
    ...
    def format_chromedriver_list(cls, operating_system):
        return [
            cls.format_driver_information(
                operating_system, '91.0.4472.19',  '91', 'chromedriver', 'Google Chrome'),
            cls.format_chromedriver_download_command(
                operating_system, '91.0.4472.19'),
            cls.format_driver_information(
                operating_system, '90.0.4430.24',  '90', 'chromedriver', 'Google Chrome'),
            cls.format_chromedriver_download_command(
                operating_system, '90.0.4430.24'),
            cls.format_driver_information(
                operating_system, '89.0.4389.23',  '89', 'chromedriver', 'Google Chrome'),
            cls.format_chromedriver_download_command(
                operating_system, '89.0.4389.23'),
            cls.format_driver_information(
                operating_system, '88.0.4324.96',  '88', 'chromedriver', 'Google Chrome'),
            cls.format_chromedriver_download_command(
                operating_system, '88.0.4324.96'),
            cls.format_driver_information(
                operating_system, '87.0.4280.88',  '87', 'chromedriver', 'Google Chrome'),
            cls.format_chromedriver_download_command(
                operating_system, '87.0.4280.88'),
            cls.format_driver_information(
                operating_system, '86.0.4240.22',  '86', 'chromedriver', 'Google Chrome'),
            cls.format_chromedriver_download_command(
                operating_system, '86.0.4240.22'),
            cls.format_driver_information(
                operating_system, '85.0.4183.87',  '85', 'chromedriver', 'Google Chrome'),
            cls.format_chromedriver_download_command(
                operating_system, '85.0.4183.87'),
            cls.format_driver_information(
                operating_system, '84.0.4147.30',  '84', 'chromedriver', 'Google Chrome'),
            cls.format_chromedriver_download_command(
                operating_system, '84.0.4147.30'),
            cls.format_driver_information(
                operating_system, '83.0.4103.39',  '83', 'chromedriver', 'Google Chrome'),
            cls.format_chromedriver_download_command(
                operating_system, '83.0.4103.39'),
            # there was no Google Chrome release for version 82
            # there was no chromedriver v.82.#.####.##
            cls.format_driver_information(
                operating_system, '81.0.4044.138', '81', 'chromedriver', 'Google Chrome'),
            cls.format_chromedriver_download_command(
                operating_system, '81.0.4044.138'),
            cls.format_driver_information(
                operating_system, '80.0.3987.106', '80', 'chromedriver', 'Google Chrome'),
            cls.format_chromedriver_download_command(
                operating_system, '80.0.3987.106'),
            cls.format_driver_information(
                operating_system, '79.0.3945.36',  '79', 'chromedriver', 'Google Chrome'),
            cls.format_chromedriver_download_command(
                operating_system, '79.0.3945.36'),
            cls.format_driver_information(
                operating_system, '78.0.3904.105', '78', 'chromedriver', 'Google Chrome'),
            cls.format_chromedriver_download_command(
                operating_system, '78.0.3904.105'),
            cls.format_driver_information(
                operating_system, '77.0.3865.40',  '77', 'chromedriver', 'Google Chrome'),
            cls.format_chromedriver_download_command(
                operating_system, '77.0.3865.40'),
            cls.format_driver_information(
                operating_system, '76.0.3809.126', '76', 'chromedriver', 'Google Chrome'),
            cls.format_chromedriver_download_command(
                operating_system, '76.0.3809.126'),
            cls.format_driver_information(
                operating_system, '75.0.3770.140', '75', 'chromedriver', 'Google Chrome'),
            cls.format_chromedriver_download_command(
                operating_system, '75.0.3770.140'),
            cls.format_driver_information(
                operating_system, '74.0.3729.6',   '74', 'chromedriver', 'Google Chrome'),
            cls.format_chromedriver_download_command(
                operating_system, '74.0.3729.6'),
            cls.format_driver_information(
                operating_system, '73.0.3683.68',  '73', 'chromedriver', 'Google Chrome'),
            cls.format_chromedriver_download_command(
                operating_system, '73.0.3683.68'),
            cls.format_driver_information(
                operating_system, '2.46',      'v71-73', 'chromedriver', 'Google Chrome'),
            cls.format_chromedriver_download_command(operating_system, '2.46'),
            cls.format_driver_information(
                operating_system, '2.45',      'v70-72', 'chromedriver', 'Google Chrome'),
            cls.format_chromedriver_download_command(operating_system, '2.45'),
            cls.format_driver_information(
                operating_system, '2.44',      'v69-71', 'chromedriver', 'Google Chrome'),
            cls.format_chromedriver_download_command(operating_system, '2.44'),
            cls.format_driver_information(
                operating_system, '2.43',      'v69-71 (use chromedriver 2.44)', 'chromedriver', 'Google Chrome'),
            cls.format_chromedriver_download_command(operating_system, '2.43'),
            cls.format_driver_information(
                operating_system, '2.42',      'v68-70', 'chromedriver', 'Google Chrome'),
            cls.format_chromedriver_download_command(operating_system, '2.42'),
            cls.format_driver_information(
                operating_system, '2.41',      'v67-69', 'chromedriver', 'Google Chrome'),
    ...
    def format_bravedriver_list(cls, operating_system):
        return [
            cls.format_driver_information(
                operating_system, 'v.90.0.4430.85',  '90', 'bravedriver (operadriver based)', 'Brave Browser'),
            cls.format_bravedriver_download_command(
                operating_system, 'v.90.0.4430.85'),
            cls.format_driver_information(
                operating_system, 'v.89.0.4389.82',  '89', 'bravedriver (operadriver based)', 'Brave Browser'),
            cls.format_bravedriver_download_command(
                operating_system, 'v.89.0.4389.82'),
            cls.format_driver_information(
                operating_system, 'v.88.0.4324.104', '88', 'bravedriver (operadriver based)', 'Brave Browser'),
            cls.format_bravedriver_download_command(
                operating_system, 'v.88.0.4324.104'),
            cls.format_driver_information(
                operating_system, 'v.87.0.4280.67',  '87', 'bravedriver (operadriver based)', 'Brave Browser'),
            cls.format_bravedriver_download_command(
                operating_system, 'v.87.0.4280.67'),
            cls.format_driver_information(
                operating_system, 'v.86.0.4240.80',  '86', 'bravedriver (operadriver based)', 'Brave Browser'),
            cls.format_bravedriver_download_command(
                operating_system, 'v.86.0.4240.80'),
            cls.format_driver_information(
                operating_system, 'v.85.0.4183.102', '85', 'bravedriver (operadriver based)', 'Brave Browser'),
            cls.format_bravedriver_download_command(
                operating_system, 'v.85.0.4183.102'),
            cls.format_driver_information(
                operating_system, 'v.84.0.4147.89',  '84', 'bravedriver (operadriver based)', 'Brave Browser'),
            cls.format_bravedriver_download_command(
                operating_system, 'v.84.0.4147.89'),
            cls.format_driver_information(
                operating_system, 'v.83.0.4103.97',  '83', 'bravedriver (operadriver based)', 'Brave Browser'),
            cls.format_bravedriver_download_command(
                operating_system, 'v.83.0.4103.97'),
            ...
            cls.format_driver_information(
                operating_system, 'v.81.0.4044.113', '81', 'bravedriver (operadriver based)', 'Brave Browser'),
            cls.format_bravedriver_download_command(
                operating_system, 'v.81.0.4044.113'),
            cls.format_driver_information(
                operating_system, 'v.80.0.3987.100', '80', 'bravedriver (operadriver based)', 'Brave Browser'),
            cls.format_bravedriver_download_command(
                operating_system, 'v.80.0.3987.100'),
            cls.format_driver_information(
                operating_system, 'v.79.0.3945.79',  '79', 'bravedriver (operadriver based)', 'Brave Browser'),
            cls.format_bravedriver_download_command(
                operating_system, 'v.79.0.3945.79'),
            cls.format_driver_information(
                operating_system, 'v.78.0.3904.87',  '78', 'bravedriver (operadriver based)', 'Brave Browser'),
            cls.format_bravedriver_download_command(
                operating_system, 'v.78.0.3904.87'),
            cls.format_driver_information(
                operating_system, 'v.77.0.3865.120', '77', 'bravedriver (operadriver based)', 'Brave Browser'),
            cls.format_bravedriver_download_command(
                operating_system, 'v.77.0.3865.120'),
            cls.format_driver_information(
                operating_system, 'v.76.0.3809.132', '76', 'bravedriver (operadriver based)', 'Brave Browser'),
            cls.format_bravedriver_download_command(
                operating_system, 'v.76.0.3809.132'),
            cls.format_driver_information(
                operating_system, 'v.75.0.3770.100', '75', 'bravedriver (operadriver based)', 'Brave Browser'),
            cls.format_bravedriver_download_command(
                operating_system, 'v.75.0.3770.100')
        ]
    ...
    def format_msedgedriver_list(cls, operating_system):
        return [
            cls.format_driver_information(
                operating_system, '92.0.881.0',   '92', 'msedgedriver', 'Microsoft Edge'),
            cls.format_msedgedriver_download_command(
                operating_system, '92.0.881.0'),
            cls.format_driver_information(
                operating_system, '91.0.864.19',  '91', 'msedgedriver', 'Microsoft Edge'),
            cls.format_msedgedriver_download_command(
                operating_system, '91.0.864.19'),
            cls.format_driver_information(
                operating_system, '90.0.818.56',  '90', 'msedgedriver', 'Microsoft Edge'),
            cls.format_msedgedriver_download_command(
                operating_system, '90.0.818.56'),
            cls.format_driver_information(
                operating_system, '89.0.774.77',  '89', 'msedgedriver', 'Microsoft Edge'),
            cls.format_msedgedriver_download_command(
                operating_system, '89.0.774.77'),
            cls.format_driver_information(
                operating_system, '88.0.705.74',  '88', 'msedgedriver', 'Microsoft Edge'),
            cls.format_msedgedriver_download_command(
                operating_system, '88.0.705.74'),
            cls.format_driver_information(
                operating_system, '87.0.669.0',   '87', 'msedgedriver', 'Microsoft Edge'),
            cls.format_msedgedriver_download_command(
                operating_system, '87.0.669.0'),
            cls.format_driver_information(
                operating_system, '86.0.622.58',  '86', 'msedgedriver', 'Microsoft Edge'),
            cls.format_msedgedriver_download_command(
                operating_system, '86.0.622.58'),
            cls.format_driver_information(
                operating_system, '85.0.564.68',  '85', 'msedgedriver', 'Microsoft Edge'),
            cls.format_msedgedriver_download_command(
                operating_system, '85.0.564.68'),
            cls.format_driver_information(
                operating_system, '84.0.524.0',   '84', 'msedgedriver', 'Microsoft Edge'),
            cls.format_msedgedriver_download_command(
                operating_system, '84.0.524.0'),
            cls.format_driver_information(
                operating_system, '83.0.478.58',  '83', 'msedgedriver', 'Microsoft Edge'),
            cls.format_msedgedriver_download_command(
                operating_system, '83.0.478.58'),
            cls.format_driver_information(
                operating_system, '82.0.459.1',   '82', 'msedgedriver', 'Microsoft Edge'),
            cls.format_msedgedriver_download_command(
                operating_system, '82.0.459.1'),
            cls.format_driver_information(
                operating_system, '81.0.409.0',   '81', 'msedgedriver', 'Microsoft Edge'),
            cls.format_msedgedriver_download_command(
                operating_system, '81.0.409.0'),
            cls.format_driver_information(
                operating_system, '80.0.361.111', '80', 'msedgedriver', 'Microsoft Edge'),
            cls.format_msedgedriver_download_command(
                operating_system, '80.0.361.111'),
            cls.format_driver_information(
                operating_system, '79.0.313.0',   '79', 'msedgedriver', 'Microsoft Edge'),
            cls.format_msedgedriver_download_command(
                operating_system, '79.0.313.0')
        ]
    ...
    def format_geckodriver_download_command(cls, operating_system, version):
        if operating_system.startswith('win'):
            return cls.format_windows_download(f'{cls.url_prefix_geckodriver}/{version}/geckodriver-{version}-{operating_system}.zip',    'geckodriver')
        else:
            return cls.format_unix_download(f'{cls.url_prefix_geckodriver}/{version}/geckodriver-{version}-{operating_system}.tar.gz', 'geckodriver')

    @classmethod
    def format_operadriver_download_command(cls, operating_system, version):
        if operating_system.startswith('win'):
            return cls.format_windows_download(f'{cls.url_prefix_operadriver}/{version}/operadriver_{operating_system}.zip', 'operadriver')
        else:
            return cls.format_unix_download(f'{cls.url_prefix_operadriver}/{version}/operadriver_{operating_system}.zip', 'operadriver')

    @classmethod
    def format_chromedriver_download_command(cls, operating_system, version):
        if operating_system.startswith('win'):
            return cls.format_windows_download(f'{cls.url_prefix_chromedriver}/{version}/chromedriver_{operating_system}.zip', 'chromedriver')
        else:
            return cls.format_unix_download(f'{cls.url_prefix_chromedriver}/{version}/chromedriver_{operating_system}.zip', 'chromedriver')
    ...
    def format_bravedriver_download_command(cls, operating_system, version):
        ...
        if operating_system.startswith('win'):
            return cls.format_windows_download(f'{cls.url_prefix_operadriver}/{version}/operadriver_{operating_system}.zip', 'bravedriver')
        else:
            return cls.format_unix_download(f'{cls.url_prefix_operadriver}/{version}/operadriver_{operating_system}.zip', 'bravedriver')

    @classmethod
    def format_msedgedriver_download_command(cls, operating_system, version):
        if operating_system.startswith('win'):
            return cls.format_windows_download(f'{cls.url_prefix_msedgedriver}/{version}/edgedriver_{operating_system}.zip', 'msedgedriver')
        else:
            return cls.format_unix_download(f'{cls.url_prefix_msedgedriver}/{version}/edgedriver_{operating_system}.zip', 'msedgedriver')

    strip_component = '--strip-components=1'

    @classmethod
    def format_unix_download(cls, url, driver):
        if driver == 'operadriver':
            driver_specific_command = f'-C /usr/local/bin/ {cls.strip_component} && rm /usr/local/bin/sha512_sum'
        elif driver == 'bravedriver':
            driver_specific_command = f'-O > /usr/local/bin/{driver} {cls.strip_component}'
        else:
            driver_specific_command = '-C /usr/local/bin/'
    ...
    def format_windows_download(cls, url, driver):
        ...
        if driver == 'operadriver':
            driver_specific_command = rf'-C {drive}:\Windows {cls.strip_component} && del {drive}:\Windows\sha512_sum'
        elif driver == 'bravedriver':
            driver_specific_command = rf'-O > {drive}:\Windows\bravedriver.exe {cls.strip_component}'
        else:
            driver_specific_command = rf'-C {drive}:\Windows'
    ...
    def display_dependency_setup_instructions(self, user_driver, user_os):
        ...
        if user_driver == 'firefox':
            print(geckodriver_download_instructions)
        elif user_driver == 'opera':
            print(operadriver_download_instructions)
        elif user_driver == 'safari':
            print('This is an MacOS specific driver.')
        elif user_driver == 'chrome':
            print(chromedriver_download_instructions)
        elif user_driver == 'brave':
            print(bravedriver_download_instructions)
        elif user_driver == 'edge':
            print(edgedriver_download_instructions)
    ...
    def display_blocking_cookie_consent(cls):
        print(
            f'Blocking consent for all cookies since program running with cookie_consent=False ...{cls.offset}')

    @classmethod
    def display_accepting_cookie_consent(cls):
        print(
            f'Accepting consent for all cookies since program running with cookie_consent=True ...{cls.offset}')

    @staticmethod
    def display_invalid_cookie_consent_option(cookie_consent):
        print(
            f'YouTube is redircting to youtube.consent.com, but you entered an invalid argument for the cookie_consent instance attrribute!\nPlease use cookie_consent=True or cookie_consent=False.\nYour current setting is: cookie_consent={cookie_consent}')
